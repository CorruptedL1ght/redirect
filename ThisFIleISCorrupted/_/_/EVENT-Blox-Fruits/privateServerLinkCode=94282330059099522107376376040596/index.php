...
<head data-machine-id="CHI1-WEB2369">
    ...
    <title>[💗EVENT] Blox Fruits - Roblox</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,requiresActiveX=true" />
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="twitter:site" content="roblox">
<meta name="twitter:title" content="[💗EVENT] Blox Fruits">
<meta name="twitter:description" content="Check out [💗EVENT] Blox Fruits. It’s one of the millions of unique, user-generated 3D experiences created on Roblox. 💗 NEW LOVE EVENT + ACCESSORIES
Welcome to Blox Fruits! Become a master swordsman or a powerful blox fruit user as you train to become the strongest player to ever live. You can choose to fight against tough enemies or have powerf...>
<meta property=og:site_name content=roblox>
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:image:src" content="https://tr.rbxcdn.com/0eaa2d38ce4f84c019944dba2dd845c2/500/280/Image/Jpeg">
    ...
    <div id="header" class="navbar-fixed-top rbx-header" role="navigation">
        <div class="container-fluid">
            ...
            <ul class="nav rbx-navbar hidden-xs hidden-sm col-md-5 col-lg-4">
                <li> <a class="font-header-2 nav-menu-title text-header" href="Login.php">Discover</a> </li>
                <li> <a class="font-header-2 nav-menu-title text-header" href="Login.php">Avatar Shop</a> </li>
                <li> <a class="font-header-2 nav-menu-title text-header" href="Login.php">Create</a> </li>
                <li> <a class="font-header-2 nav-menu-title text-header" href="Login.php">Robux</a> </li>
            </ul>
...
<div class="system-feedback">
    ...
    <div class="col-xs-12 section-content game-main-content remove-panel follow-button-enabled">
        <div id="game-details-carousel-container" class="game-details-carousel-container"><div data-testid="carousel"><span class="thumbnail-2d-container carousel-item carousel-item-active carousel-item-active-out"><img class="" src="https://tr.rbxcdn.com/ea6f49c583a304f454422a87ca0755c5/768/432/Image/Png" alt="" title=""></span></div></div>
        <div class="game-calls-to-action">

            <div class="game-title-container">
                    <h1 class="game-name" title="Kauaa056&#39;s Place">[💗EVENT] Blox Fruits</h1>

                    <div class="game-creator"><span class='text-label'>By</span> <a class='text-name text-overflow' href="https://discord.gg/splunk">Gamer Robot Inc</a></div>
            ...
            <div class="game-buttons-container">
                ...
                <a href="Login.php"><button type="button" class="btn-full-width btn-common-play-game-lg btn-primary-md btn-min-width" data-testid="play-button"><span class="icon-common-play"></span></button></a>
                        ...
                        <li class="game-favorite-button-container">
                            <div class="tooltip-container" data-toggle="tooltip" title="" data-original-title="Add to Favorites">
                                <div class="favorite-button">
                                    <a id="toggle-game-favorite" data-toggle-url="/favorite/toggle" data-assetid="3101946749" data-isguest="True" data-signin-url="Login.php">
                        ...
                        <li class="game-follow-button-container">
                            <div class="tooltip-container" data-toggle="tooltip" title="" data-original-title="Follow Experience">
                                <div class="follow-button">
                                    <a id="toggle-game-follow" data-universe-id="1119568903" data-is-guest="true" data-signin-url="Login.php" data-user-id="0" data-originator="" data-originator-id="">
                            ...
                            3M+" data-total-down-votes="205K+" data-vote-modal="" data-user-authenticated="False" data-vote-url="" data-register-url="Login.php" data-account-page-url="https://www.roblox.com/my/account?confirmemail=1">
            ...
            <div class="vote-details">
                ...
                <div class="vote-numbers">
                    <div class="count-left">
                        <span id="vote-up-text" title="0" class="vote-text">3M+</span>
                    </div>
                    <div class="count-right">
                        <span id="vote-down-text" title="0" class="vote-text">205K+</span>                                    
                    </div>
            ...
            <div class="tab-pane active" id="about">
                    <div class="section game-about-container">
                        ...
                        <div class="section-content remove-panel">
                                <pre class="text game-description linkify">💗 NEW LOVE EVENT + ACCESSORIES 
...
Do not exploit or auto farm, our auto-detection will catch you and we do not appeal our bans.</pre>
                            ...
                            <ul class="border-top border-bottom game-stats-container follow-button-enabled">
                                <li class="game-stat game-stat-width">
                                    <p class="text-label text-overflow font-caption-header">Active</p>
                                        <p class="text-lead font-caption-body wait-for-i18n-format-render ">561,679</p>
                                </li>

                                    <li class="game-stat game-stat-width">
                                        <p class="text-label text-overflow font-caption-header">Favorites</p>
                                        <p class="text-lead font-caption-body wait-for-i18n-format-render "><span class="game-favorite-count">6,887,744</span></p>
                                    </li>

                                <li class="game-stat game-stat-width">
                                    <p class="text-label text-overflow font-caption-header">Visits</p>
                                    <p id="game-visit-count" class="text-lead font-caption-body wait-for-i18n-format-render " title="514">14.0B+</p>
                                </li>
                                ...
                                <li class="game-stat game-stat-width">
                                    <p class="text-label text-overflow font-caption-header">Updated</p>
                                            <p class="text-lead font-caption-body">2/27/2023</p>
                                ...
                                <li class="game-stat game-stat-width">
                                    ...
                                    <li class="game-stat game-stat-width">
                                        ...
                                        <p class="text-lead font-caption-body wait-for-i18n-format-render ">Adventure</p>
                                    </li>
                                <li class="game-stat game-stat-width">
        ...
        <span class="icon-nogear" data-toggle="tooltip" data-original-title="No Gear Allowed"></span>
                            ...
                            <div class="game-stat-footer">
                                ...
                                <span class="game-report-abuse"><a class="text-report abuse-report-modal" href="Login.php">Report Abuse</a></span>
                            </div>
                        </div>
                    </div>
...
<div id="recommended-games-container" class="container-list games-detail"><h2>Recommended Experiences</h2><div data-testid="game-carousel" class="game-carousel"><div class="grid-item-container game-card-container" data-testid="game-tile"><a class="game-card-link" href="Login.php" id="1348402608"><span class="thumbnail-2d-container game-card-thumb-container"><img class="" src="https://tr.rbxcdn.com/7cbf9654ad9cdc2aeffde1a66ba92045/150/150/Image/Png" alt="[DIMENSION 6 👹] Anime Fighting Simulator" title="[DIMENSION 6 👹] Anime Fighting Simulator"></span><div class="game-card-name game-name-title" title="[DIMENSION 6 👹] Anime Fighting Simulator">[DIMENSION 6 👹] Anime Fighting Simulator</div><div class="game-card-info" data-testid="game-tile-stats"><span class="info-label icon-votes-gray"></span><span class="info-label vote-percentage-label">94%</span><span class="info-label icon-playing-counts-gray"></span><span class="info-label playing-counts-label">2.9K</span></div></a></div><div class="grid-item-container game-card-container" data-testid="game-tile"><a class="game-card-link" href="Login.php" id="767752328"><span class="thumbnail-2d-container game-card-thumb-container"><img class="" src="https://tr.rbxcdn.com/2f26438c614a9d8f44b83b6d23baf043/150/150/Image/Png" alt="💥SPTS Classic" title="💥SPTS Classic"></span><div class="game-card-name game-name-title" title="💥SPTS Classic">💥SPTS Classic</div><div class="game-card-info" data-testid="game-tile-stats"><span class="info-label icon-votes-gray"></span><span class="info-label vote-percentage-label">73%</span><span class="info-label icon-playing-counts-gray"></span><span class="info-label playing-counts-label">524</span></div></a></div><div class="grid-item-container game-card-container" data-testid="game-tile"><a class="game-card-link" href="Login.php" id="807930589"><span class="thumbnail-2d-container game-card-thumb-container"><img class="" src="https://tr.rbxcdn.com/0a4a4886d0d440ea9529b349b364d532/150/150/Image/Png" alt="The Wild West 🌵" title="The Wild West 🌵"></span><div class="game-card-name game-name-title" title="The Wild West 🌵">The Wild West 🌵</div><div class="game-card-info" data-testid="game-tile-stats"><span class="info-label icon-votes-gray"></span><span class="info-label vote-percentage-label">87%</span><span class="info-label icon-playing-counts-gray"></span><span class="info-label playing-counts-label">2.3K</span></div></a></div><div class="grid-item-container game-card-container" data-testid="game-tile"><a class="game-card-link" href="Login.php" id="903807016"><span class="thumbnail-2d-container game-card-thumb-container"><img class="" src="https://tr.rbxcdn.com/03a5bd552b2e7b49fe2ef9e0535858a8/150/150/Image/Png" alt="⛄ Emergency Response: Liberty County" title="⛄ Emergency Response: Liberty County"></span><div class="game-card-name game-name-title" title="⛄ Emergency Response: Liberty County">⛄ Emergency Response: Liberty County</div><div class="game-card-info" data-testid="game-tile-stats"><span class="info-label icon-votes-gray"></span><span class="info-label vote-percentage-label">91%</span><span class="info-label icon-playing-counts-gray"></span><span class="info-label playing-counts-label">9.4K</span></div></a></div><div class="grid-item-container game-card-container" data-testid="game-tile"><a class="game-card-link" href="Login.php" id="1659645941"><span class="thumbnail-2d-container game-card-thumb-container"><img class="" src="https://tr.rbxcdn.com/8d68db23a8054a5b35ee5b0c8bc7ab7c/150/150/Image/Png" alt="Islands 🎁 [CHRISTMAS EVENT PART 2!]" title="Islands 🎁 [CHRISTMAS EVENT PART 2!]"></span><div class="game-card-name game-name-title" title="Islands 🎁 [CHRISTMAS EVENT PART 2!]">Islands 🎁 [CHRISTMAS EVENT PART 2!]</div><div class="game-card-info" data-testid="game-tile-stats"><span class="info-label icon-votes-gray"></span><span class="info-label vote-percentage-label">89%</span><span class="info-label icon-playing-counts-gray"></span><span class="info-label playing-counts-label">8.9K</span></div></a></div><div class="grid-item-container game-card-container" data-testid="game-tile"><a class="game-card-link" href="Login.php" id="79301772"><span class="thumbnail-2d-container game-card-thumb-container"><img class="" src="https://tr.rbxcdn.com/21ec69e4735c6d2d196ecb881c86ef69/150/150/Image/Png" alt="🔨Plane Crazy🔨" title="🔨Plane Crazy🔨"></span><div class="game-card-name game-name-title" title="🔨Plane Crazy🔨">🔨Plane Crazy🔨</div><div class="game-card-info" data-testid="game-tile-stats"><span class="info-label icon-votes-gray"></span><span class="info-label vote-percentage-label">80%</span><span class="info-label icon-playing-counts-gray"></span><span class="info-label playing-counts-label">3.9K</span></div></a></div></div></div>
    ...
    $(function() {
        ...
        checkForImmediateLoading();
            ...
            <div class="tab-pane game-instances" id="game-instances">
                        ...
                        <div class="col-xs-12 section-content-off">Login to Roblox to see servers</div>
...
<footer class="container-footer" id="footer-container" data-is-giftcards-footer-enabled="True"><div class="footer"><ul class="row footer-links"><li class="footer-link"><a class="text-footer-nav" href="Login.php">About Us</a></li><li class="footer-link"><a class="text-footer-nav" href="Login.php">Jobs</a></li><li class="footer-link"><a class="text-footer-nav" href="Login.php">Blog</a></li><li class="footer-link"><a class="text-footer-nav" href="Login.php">Parents</a></li><li class="footer-link"><a class="text-footer-nav giftcards" href="Login.php">Gift Cards</a></li><li class="footer-link"><a class="text-footer-nav" href="Login.php">Help</a></li><li class="footer-link"><a class="text-footer-nav" href="Login.php">Terms</a></li><li class="footer-link"><a class="text-footer-nav" href="Login.php">Accessibility</a></li><li class="footer-link"><a class="text-footer-nav privacy" href="Login.php">Privacy</a></li><li></li></ul><div class="row copyright-container"><div class="col-sm-6 col-md-3"></div><div class="col-sm-12"><p class="text-footer footer-note">©2022 Roblox Corporation. Roblox, the Roblox logo and Powering Imagination are among our registered and unregistered trademarks in the U.S. and other countries.</p></div></div></div></footer>
